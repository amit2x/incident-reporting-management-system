                ...
                <div class="row g-2 align-items-end">
                    ...
                    <div class="col-md-2 col-sm-4">
                        <select name="status" class="form-select form-select-sm">
                            ...
                            <option value="{{ $key }}" {{ request('status')==$key ? 'selected' : '' }}>{{ $s['label'] }}
                            </option>
                            @endforeach
                        </select>
                    </div>
        ...
        <div class="card mb-3">
            ...
            <div class="card-header d-md-none bg-transparent border-0 py-2">
                <button class="btn btn-outline-secondary btn-sm w-100 d-flex align-items-center justify-content-between"
                    type="button" data-bs-toggle="collapse" data-bs-target="#mobileFilterCollapse" aria-expanded="false"
                ...
                <div class="col-md-1 col-sm-4 ms-auto d-flex justify-content-end">
                    <div class="d-flex gap-1">
                        <button type="button" class="view-toggle-btn active" onclick="switchView('table')" id="tableBtn"
                            title="Table"><i class="fas fa-list"></i></button>
                        <button type="button" class="view-toggle-btn" onclick="switchView('cards')" id="cardsBtn"
                            title="Cards"><i class="fas fa-th-large"></i></button>
                    </div>
                </div>
                        ...
                        <div class="row g-2 align-items-end">
                            ...
                            <div class="col-12 col-md-auto ms-md-auto d-flex gap-1 pt-2 pt-md-0">
                                ...
                                <a href="{{ route('incidents.index') }}"
                                    class="btn btn-light btn-sm flex-fill flex-md-grow-0">
                                ...
                                <div class="col-md-1 col-sm-4 ms-auto d-flex justify-content-end">
                                    <div class="d-flex gap-1">
                                        <button type="button" class="view-toggle-btn active"
                                            onclick="switchView('table')" id="tableBtn" title="Table"><i
