<aside class="desktop-sidebar" id="desktopSidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <div class="nav-section">
            ...
            <div class="nav-item">
                <a href="{{ route('incidents.index') }}" class="nav-link {{ request()->routeIs('incidents.*') && !request()->routeIs('incidents.create') ? 'active' : '' }}">
                    <i class="fas fa-clipboard-list"></i>
                    <span>All Incidents</span>
                    @php $openCount = \App\Models\Incident::whereIn('status', ['open','acknowledged','in_progress'])->count(); @endphp
                    @if($openCount > 0)
        ...
        <div class="nav-section">
            ...
            <div class="nav-item">
                <a href="{{ route('admin.escalation-matrix.index') }}" class="nav-link {{ request()->routeIs('admin.escalation-matrix.*') ? 'active' : '' }}">
    ...
    <div class="sidebar-footer">
        <div class="d-flex align-items-center gap-3">
            <img src="{{ Auth::user()->avatar_url }}" alt="User" class="rounded-circle" width="40" height="40" style="object-fit: cover;">
